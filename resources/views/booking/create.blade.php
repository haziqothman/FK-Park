        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div class="flex justify-center mb-6">
                        <img src="{{ asset('image/parking.png') }}" alt="Booking Image" class="w-1/1 h-auto">
                    </div>
                <form action="{{ route('bookings.store') }}" method="POST">
                    ...
                    <div class="flex justify-end">
                        ...
                        <a href="{{ route('dashboard') }}" class="px-4 py-2 bg-gray-600 border border-transparent rounded-md font-semibold text-xs text-black uppercase tracking-widest hover:bg-gray-500 focus:outline-none focus:border-gray-700 focus:ring focus:ring-gray-300 disabled:opacity-25 transition"style="color:red;">Cancel</a>
                    </div>
                </form>
