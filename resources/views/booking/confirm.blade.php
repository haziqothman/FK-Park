        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <ul>
                        <li><strong>Vehicle ID:</strong> {{ $bookingDetails['vehicleID'] }}</li>
                    ...
                    <div class="mt-6 flex justify-end">
                        ...
                        <a href="{{ route('bookings.create') }}" class="px-4 py-2 bg-gray-600 border border-transparent rounded-md font-semibold text-xs text-black uppercase tracking-widest hover:bg-gray-500 focus:outline-none focus:border-gray-700 focus:ring focus:ring-gray-300 disabled:opacity-25 transition" style="color:red;">Cancel</a>
                    </div>
                </div>
            </div>
        </div>
